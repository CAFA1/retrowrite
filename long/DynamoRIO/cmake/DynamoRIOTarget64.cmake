...
foreach(_expectedTarget dynamorio dynamorio_static drinjectlib drdecode drhelper drmemfuncs drconfiglib drfrontendlib drmemtrace_reuse_distance drmemtrace_histogram drmemtrace_reuse_time drmemtrace_basic_counts drmemtrace_opcode_mix drmemtrace_view drmemtrace_simulator directory_iterator drmemtrace_raw2trace drmemtrace_analyzer drcontainers drgui drmgr drmgr_static drx drx_static drwrap drwrap_static drreg drreg_static drsyms drsyms_static drutil drutil_static drcovlib drcovlib_static)
...
set_target_properties(dynamorio_static PROPERTIES
  INTERFACE_LINK_LIBRARIES "drhelper;dl"
)
...
set_target_properties(drinjectlib PROPERTIES
  INTERFACE_LINK_LIBRARIES "drdecode;drhelper;drmemfuncs"
)
...
set_target_properties(drdecode PROPERTIES
  INTERFACE_LINK_LIBRARIES "drhelper"
)
...
set_target_properties(drfrontendlib PROPERTIES
  INTERFACE_LINK_LIBRARIES "drhelper;drmemfuncs"
)
...
set_target_properties(drmemtrace_raw2trace PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;directory_iterator;drfrontendlib;drutil_static;/usr/lib64/libpthread.so;/usr/lib64/libz.so"
)
...
set_target_properties(drmemtrace_analyzer PROPERTIES
  INTERFACE_LINK_LIBRARIES "directory_iterator;/usr/lib64/libpthread.so"
)
...
set_target_properties(drsyms PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;drcontainers;/dynamorio_package/ext/drsyms/libelftc/lib64/libdwarf.a;/dynamorio_package/ext/drsyms/libelftc/lib64/libelftc.a;/dynamorio_package/ext/drsyms/libelftc/lib64/libelf.a"
)
